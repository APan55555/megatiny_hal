...
pub type CAPTEI_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `CAPTEI` writer - Event Input Enable"]
pub type CAPTEI_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRL_SPEC, bool, O>;
#[doc = "Field `EDGE` reader - Event Edge"]
pub type EDGE_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `EDGE` writer - Event Edge"]
pub type EDGE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRL_SPEC, bool, O>;
#[doc = "Field `FILTER` reader - Input Capture Noise Cancellation Filter"]
pub type FILTER_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `FILTER` writer - Input Capture Noise Cancellation Filter"]
pub type FILTER_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRL_SPEC, bool, O>;
impl R {
