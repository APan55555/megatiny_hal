...
pub type HYSMODE_R = crate::attiny412pac::FieldReader<u8, HYSMODE_A>;
impl HYSMODE_R {
...
pub type HYSMODE_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriterSafe<'a, u8, CTRLA_SPEC, u8, HYSMODE_A, 2, O>;
...
pub type LPMODE_R = crate::attiny412pac::BitReader<LPMODE_A>;
impl LPMODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type LPMODE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, LPMODE_A, O>;
...
pub type INTMODE_R = crate::attiny412pac::FieldReader<u8, INTMODE_A>;
impl INTMODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type INTMODE_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, CTRLA_SPEC, u8, INTMODE_A, 2, O>;
...
pub type OUTEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
