...
pub type TRIGA_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `TRIGA` writer - Trigger A interrupt enable"]
pub type TRIGA_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
#[doc = "Field `TRIGB` reader - Trigger B interrupt enable"]
pub type TRIGB_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `TRIGB` writer - Trigger B interrupt enable"]
pub type TRIGB_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
impl R {
