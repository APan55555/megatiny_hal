...
pub struct R(crate::attiny412pac::R<EVCTRLA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<EVCTRLA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<EVCTRLA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<EVCTRLA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EVCTRLA` writer"]
pub struct W(crate::attiny412pac::W<EVCTRLA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<EVCTRLA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<EVCTRLA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<EVCTRLA_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TRIGEI` reader - Trigger event enable"]
pub type TRIGEI_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `TRIGEI` writer - Trigger event enable"]
pub type TRIGEI_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLA_SPEC, bool, O>;
#[doc = "event action\n\nValue on reset: 0"]
...
pub type ACTION_R = crate::attiny412pac::BitReader<ACTION_A>;
impl ACTION_R {
...
pub type ACTION_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLA_SPEC, ACTION_A, O>;
...
pub type EDGE_R = crate::attiny412pac::BitReader<EDGE_A>;
impl EDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type EDGE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLA_SPEC, EDGE_A, O>;
...
pub type CFG_R = crate::attiny412pac::FieldReader<u8, CFG_A>;
impl CFG_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type CFG_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, EVCTRLA_SPEC, u8, CFG_A, 2, O>;
...
impl crate::attiny412pac::RegisterSpec for EVCTRLA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [evctrla::R](R) reader structure"]
impl crate::attiny412pac::Readable for EVCTRLA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [evctrla::W](W) writer structure"]
impl crate::attiny412pac::Writable for EVCTRLA_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EVCTRLA to value 0"]
impl crate::attiny412pac::Resettable for EVCTRLA_SPEC {
    #[inline(always)]
