...
pub struct R(crate::attiny412pac::R<DLYCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<DLYCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<DLYCTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<DLYCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DLYCTRL` writer"]
pub struct W(crate::attiny412pac::W<DLYCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<DLYCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<DLYCTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<DLYCTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Delay select\n\nValue on reset: 0"]
...
pub type DLYSEL_R = crate::attiny412pac::FieldReader<u8, DLYSEL_A>;
impl DLYSEL_R {
...
pub type DLYSEL_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, DLYCTRL_SPEC, u8, DLYSEL_A, 2, O>;
...
pub type DLYTRIG_R = crate::attiny412pac::FieldReader<u8, DLYTRIG_A>;
impl DLYTRIG_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type DLYTRIG_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriterSafe<'a, u8, DLYCTRL_SPEC, u8, DLYTRIG_A, 2, O>;
...
pub type DLYPRESC_R = crate::attiny412pac::FieldReader<u8, DLYPRESC_A>;
impl DLYPRESC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type DLYPRESC_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriterSafe<'a, u8, DLYCTRL_SPEC, u8, DLYPRESC_A, 2, O>;
...
impl crate::attiny412pac::RegisterSpec for DLYCTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dlyctrl::R](R) reader structure"]
impl crate::attiny412pac::Readable for DLYCTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dlyctrl::W](W) writer structure"]
impl crate::attiny412pac::Writable for DLYCTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DLYCTRL to value 0"]
impl crate::attiny412pac::Resettable for DLYCTRL_SPEC {
    #[inline(always)]
