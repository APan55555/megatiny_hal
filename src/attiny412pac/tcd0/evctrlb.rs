...
pub struct R(crate::attiny412pac::R<EVCTRLB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<EVCTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<EVCTRLB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<EVCTRLB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EVCTRLB` writer"]
pub struct W(crate::attiny412pac::W<EVCTRLB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<EVCTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<EVCTRLB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<EVCTRLB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TRIGEI_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLB_SPEC, bool, O>;
#[doc = "event action\n\nValue on reset: 0"]
...
pub type ACTION_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLB_SPEC, ACTION_A, O>;
...
pub type EDGE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, EVCTRLB_SPEC, EDGE_A, O>;
...
pub type CFG_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, EVCTRLB_SPEC, u8, CFG_A, 2, O>;
...
impl crate::attiny412pac::RegisterSpec for EVCTRLB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [evctrlb::R](R) reader structure"]
impl crate::attiny412pac::Readable for EVCTRLB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [evctrlb::W](W) writer structure"]
impl crate::attiny412pac::Writable for EVCTRLB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EVCTRLB to value 0"]
impl crate::attiny412pac::Resettable for EVCTRLB_SPEC {
    #[inline(always)]
