...
pub type ENRDY_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `CMDRDY` reader - Command ready"]
pub type CMDRDY_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `PWMACTA` reader - PWM activity on A"]
pub type PWMACTA_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `PWMACTA` writer - PWM activity on A"]
pub type PWMACTA_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, STATUS_SPEC, bool, O>;
#[doc = "Field `PWMACTB` reader - PWM activity on B"]
pub type PWMACTB_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `PWMACTB` writer - PWM activity on B"]
pub type PWMACTB_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, STATUS_SPEC, bool, O>;
impl R {
