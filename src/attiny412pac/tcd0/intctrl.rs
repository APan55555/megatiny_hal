...
pub type TRIGA_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTCTRL_SPEC, bool, O>;
...
pub type TRIGB_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTCTRL_SPEC, bool, O>;
impl R {
