...
pub struct R(crate::attiny412pac::R<FAULTCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<FAULTCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<FAULTCTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<FAULTCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FAULTCTRL` writer"]
pub struct W(crate::attiny412pac::W<FAULTCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<FAULTCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<FAULTCTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<FAULTCTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMPA_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPB_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPC_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPD_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPAEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPBEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPCEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
...
pub type CMPDEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, FAULTCTRL_SPEC, bool, O>;
impl R {
...
impl crate::attiny412pac::RegisterSpec for FAULTCTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [faultctrl::R](R) reader structure"]
impl crate::attiny412pac::Readable for FAULTCTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [faultctrl::W](W) writer structure"]
impl crate::attiny412pac::Writable for FAULTCTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FAULTCTRL to value 0"]
impl crate::attiny412pac::Resettable for FAULTCTRL_SPEC {
    #[inline(always)]
