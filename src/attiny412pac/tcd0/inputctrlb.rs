...
pub struct R(crate::attiny412pac::R<INPUTCTRLB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<INPUTCTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<INPUTCTRLB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<INPUTCTRLB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INPUTCTRLB` writer"]
pub struct W(crate::attiny412pac::W<INPUTCTRLB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<INPUTCTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<INPUTCTRLB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<INPUTCTRLB_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Input mode\n\nValue on reset: 0"]
...
pub type INPUTMODE_R = crate::attiny412pac::FieldReader<u8, INPUTMODE_A>;
impl INPUTMODE_R {
...
pub type INPUTMODE_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, INPUTCTRLB_SPEC, u8, INPUTMODE_A, 4, O>;
...
impl crate::attiny412pac::RegisterSpec for INPUTCTRLB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [inputctrlb::R](R) reader structure"]
impl crate::attiny412pac::Readable for INPUTCTRLB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [inputctrlb::W](W) writer structure"]
impl crate::attiny412pac::Writable for INPUTCTRLB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets INPUTCTRLB to value 0"]
impl crate::attiny412pac::Resettable for INPUTCTRLB_SPEC {
    #[inline(always)]
