...
pub type SAMPNUM_R = crate::attiny412pac::FieldReader<u8, SAMPNUM_A>;
impl SAMPNUM_R {
...
pub type SAMPNUM_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, CTRLB_SPEC, u8, SAMPNUM_A, 3, O>;
...
impl R {
    ...
    pub fn sampnum(&self) -> SAMPNUM_R {
        SAMPNUM_R::new((self.bits & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Accumulation Samples"]
