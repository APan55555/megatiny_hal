...
pub type SAMPDLY_R = crate::attiny412pac::FieldReader<u8, u8>;
#[doc = "Field `SAMPDLY` writer - Sampling Delay Selection"]
pub type SAMPDLY_W<'a, const O: u8> = crate::attiny412pac::FieldWriterSafe<'a, u8, CTRLD_SPEC, u8, u8, 4, O>;
...
pub type ASDV_R = crate::attiny412pac::BitReader<ASDV_A>;
impl ASDV_R {
...
pub type ASDV_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLD_SPEC, ASDV_A, O>;
...
pub type INITDLY_R = crate::attiny412pac::FieldReader<u8, INITDLY_A>;
impl INITDLY_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type INITDLY_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, CTRLD_SPEC, u8, INITDLY_A, 3, O>;
...
impl R {
    ...
    pub fn sampdly(&self) -> SAMPDLY_R {
        SAMPDLY_R::new((self.bits & 0x0f) as u8)
    }
    ...
    pub fn initdly(&self) -> INITDLY_R {
        INITDLY_R::new(((self.bits >> 5) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Sampling Delay Selection"]
