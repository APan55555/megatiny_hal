...
pub type RESRDY_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
...
pub type WCMP_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
impl R {
