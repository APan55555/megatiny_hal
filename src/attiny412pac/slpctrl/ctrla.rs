...
pub type SEN_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `SEN` writer - Sleep enable"]
pub type SEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
#[doc = "Sleep mode\n\nValue on reset: 0"]
...
pub type SMODE_R = crate::attiny412pac::FieldReader<u8, SMODE_A>;
impl SMODE_R {
...
pub type SMODE_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, CTRLA_SPEC, u8, SMODE_A, 2, O>;
