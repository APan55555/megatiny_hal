...
pub struct R(crate::attiny412pac::R<LUT1CTRLB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<LUT1CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<LUT1CTRLB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<LUT1CTRLB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LUT1CTRLB` writer"]
pub struct W(crate::attiny412pac::W<LUT1CTRLB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<LUT1CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<LUT1CTRLB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<LUT1CTRLB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INSEL0_R = crate::attiny412pac::FieldReader<u8, INSEL0_A>;
impl INSEL0_R {
...
pub type INSEL0_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, LUT1CTRLB_SPEC, u8, INSEL0_A, 4, O>;
...
pub type INSEL1_R = crate::attiny412pac::FieldReader<u8, INSEL1_A>;
impl INSEL1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type INSEL1_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, LUT1CTRLB_SPEC, u8, INSEL1_A, 4, O>;
...
impl R {
    ...
    pub fn insel0(&self) -> INSEL0_R {
        INSEL0_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:7 - LUT Input 1 Source Selection"]
    #[inline(always)]
    pub fn insel1(&self) -> INSEL1_R {
        INSEL1_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - LUT Input 0 Source Selection"]
...
impl crate::attiny412pac::RegisterSpec for LUT1CTRLB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [lut1ctrlb::R](R) reader structure"]
impl crate::attiny412pac::Readable for LUT1CTRLB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut1ctrlb::W](W) writer structure"]
impl crate::attiny412pac::Writable for LUT1CTRLB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets LUT1CTRLB to value 0"]
impl crate::attiny412pac::Resettable for LUT1CTRLB_SPEC {
    #[inline(always)]
