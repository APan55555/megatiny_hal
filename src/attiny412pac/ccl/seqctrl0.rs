...
pub struct R(crate::attiny412pac::R<SEQCTRL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<SEQCTRL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<SEQCTRL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<SEQCTRL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEQCTRL0` writer"]
pub struct W(crate::attiny412pac::W<SEQCTRL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<SEQCTRL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<SEQCTRL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<SEQCTRL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SEQSEL_R = crate::attiny412pac::FieldReader<u8, SEQSEL_A>;
impl SEQSEL_R {
...
pub type SEQSEL_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, SEQCTRL0_SPEC, u8, SEQSEL_A, 3, O>;
...
impl R {
    ...
    pub fn seqsel(&self) -> SEQSEL_R {
        SEQSEL_R::new((self.bits & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Sequential Selection"]
...
impl crate::attiny412pac::RegisterSpec for SEQCTRL0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [seqctrl0::R](R) reader structure"]
impl crate::attiny412pac::Readable for SEQCTRL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [seqctrl0::W](W) writer structure"]
impl crate::attiny412pac::Writable for SEQCTRL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SEQCTRL0 to value 0"]
impl crate::attiny412pac::Resettable for SEQCTRL0_SPEC {
    #[inline(always)]
