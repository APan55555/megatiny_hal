...
pub struct R(crate::attiny412pac::R<PITCTRLA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<PITCTRLA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<PITCTRLA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<PITCTRLA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PITCTRLA` writer"]
pub struct W(crate::attiny412pac::W<PITCTRLA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<PITCTRLA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<PITCTRLA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<PITCTRLA_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PITEN` reader - Enable"]
pub type PITEN_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `PITEN` writer - Enable"]
pub type PITEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, PITCTRLA_SPEC, bool, O>;
#[doc = "Period\n\nValue on reset: 0"]
...
pub type PERIOD_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, PITCTRLA_SPEC, u8, PERIOD_A, 4, O>;
...
impl R {
    ...
    pub fn period(&self) -> PERIOD_R {
        PERIOD_R::new(((self.bits >> 3) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Enable"]
...
impl crate::attiny412pac::RegisterSpec for PITCTRLA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [pitctrla::R](R) reader structure"]
impl crate::attiny412pac::Readable for PITCTRLA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pitctrla::W](W) writer structure"]
impl crate::attiny412pac::Writable for PITCTRLA_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PITCTRLA to value 0"]
impl crate::attiny412pac::Resettable for PITCTRLA_SPEC {
    #[inline(always)]
