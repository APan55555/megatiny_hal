...
pub struct R(crate::attiny412pac::R<CLKSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<CLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<CLKSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<CLKSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLKSEL` writer"]
pub struct W(crate::attiny412pac::W<CLKSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<CLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<CLKSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<CLKSEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Clock Select\n\nValue on reset: 0"]
...
pub type CLKSEL_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriterSafe<'a, u8, CLKSEL_SPEC, u8, CLKSEL_A, 2, O>;
...
impl crate::attiny412pac::RegisterSpec for CLKSEL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [clksel::R](R) reader structure"]
impl crate::attiny412pac::Readable for CLKSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clksel::W](W) writer structure"]
impl crate::attiny412pac::Writable for CLKSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CLKSEL to value 0"]
impl crate::attiny412pac::Resettable for CLKSEL_SPEC {
    #[inline(always)]
