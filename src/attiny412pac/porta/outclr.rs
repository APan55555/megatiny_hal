...
pub struct R(crate::attiny412pac::R<OUTCLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<OUTCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<OUTCLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<OUTCLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OUTCLR` writer"]
pub struct W(crate::attiny412pac::W<OUTCLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<OUTCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<OUTCLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<OUTCLR_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::attiny412pac::RegisterSpec for OUTCLR_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [outclr::R](R) reader structure"]
impl crate::attiny412pac::Readable for OUTCLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [outclr::W](W) writer structure"]
impl crate::attiny412pac::Writable for OUTCLR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OUTCLR to value 0"]
impl crate::attiny412pac::Resettable for OUTCLR_SPEC {
    #[inline(always)]
