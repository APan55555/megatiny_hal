...
pub struct R(crate::attiny412pac::R<DIRTGL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<DIRTGL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<DIRTGL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<DIRTGL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIRTGL` writer"]
pub struct W(crate::attiny412pac::W<DIRTGL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<DIRTGL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<DIRTGL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<DIRTGL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::attiny412pac::RegisterSpec for DIRTGL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dirtgl::R](R) reader structure"]
impl crate::attiny412pac::Readable for DIRTGL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dirtgl::W](W) writer structure"]
impl crate::attiny412pac::Writable for DIRTGL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DIRTGL to value 0"]
impl crate::attiny412pac::Resettable for DIRTGL_SPEC {
    #[inline(always)]
