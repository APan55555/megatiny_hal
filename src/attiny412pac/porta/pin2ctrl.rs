...
pub struct R(crate::attiny412pac::R<PIN2CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<PIN2CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<PIN2CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<PIN2CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIN2CTRL` writer"]
pub struct W(crate::attiny412pac::W<PIN2CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<PIN2CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<PIN2CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<PIN2CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ISC_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, PIN2CTRL_SPEC, u8, ISC_A, 3, O>;
...
pub type PULLUPEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, PIN2CTRL_SPEC, bool, O>;
...
pub type INVEN_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, PIN2CTRL_SPEC, bool, O>;
impl R {
...
impl crate::attiny412pac::RegisterSpec for PIN2CTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [pin2ctrl::R](R) reader structure"]
impl crate::attiny412pac::Readable for PIN2CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pin2ctrl::W](W) writer structure"]
impl crate::attiny412pac::Writable for PIN2CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIN2CTRL to value 0"]
impl crate::attiny412pac::Resettable for PIN2CTRL_SPEC {
    #[inline(always)]
