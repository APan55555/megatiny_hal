...
pub struct R(crate::attiny412pac::R<DIRSET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<DIRSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<DIRSET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<DIRSET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIRSET` writer"]
pub struct W(crate::attiny412pac::W<DIRSET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<DIRSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<DIRSET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<DIRSET_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::attiny412pac::RegisterSpec for DIRSET_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dirset::R](R) reader structure"]
impl crate::attiny412pac::Readable for DIRSET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dirset::W](W) writer structure"]
impl crate::attiny412pac::Writable for DIRSET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DIRSET to value 0"]
impl crate::attiny412pac::Resettable for DIRSET_SPEC {
    #[inline(always)]
