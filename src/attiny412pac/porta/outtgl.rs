...
pub struct R(crate::attiny412pac::R<OUTTGL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<OUTTGL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<OUTTGL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<OUTTGL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OUTTGL` writer"]
pub struct W(crate::attiny412pac::W<OUTTGL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<OUTTGL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<OUTTGL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<OUTTGL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::attiny412pac::RegisterSpec for OUTTGL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [outtgl::R](R) reader structure"]
impl crate::attiny412pac::Readable for OUTTGL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [outtgl::W](W) writer structure"]
impl crate::attiny412pac::Writable for OUTTGL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OUTTGL to value 0"]
impl crate::attiny412pac::Resettable for OUTTGL_SPEC {
    #[inline(always)]
