...
pub struct R(crate::attiny412pac::R<MSTATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<MSTATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<MSTATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<MSTATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MSTATUS` writer"]
pub struct W(crate::attiny412pac::W<MSTATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<MSTATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<MSTATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<MSTATUS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Bus State\n\nValue on reset: 0"]
...
pub type BUSSTATE_R = crate::attiny412pac::FieldReader<u8, BUSSTATE_A>;
impl BUSSTATE_R {
...
pub type BUSSTATE_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriterSafe<'a, u8, MSTATUS_SPEC, u8, BUSSTATE_A, 2, O>;
...
pub type BUSERR_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, MSTATUS_SPEC, bool, O>;
#[doc = "Field `ARBLOST` reader - Arbitration Lost"]
pub type ARBLOST_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `ARBLOST` writer - Arbitration Lost"]
pub type ARBLOST_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, MSTATUS_SPEC, bool, O>;
...
pub type CLKHOLD_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, MSTATUS_SPEC, bool, O>;
#[doc = "Field `WIF` reader - Write Interrupt Flag"]
pub type WIF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `WIF` writer - Write Interrupt Flag"]
pub type WIF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, MSTATUS_SPEC, bool, O>;
#[doc = "Field `RIF` reader - Read Interrupt Flag"]
pub type RIF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `RIF` writer - Read Interrupt Flag"]
pub type RIF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, MSTATUS_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - Bus State"]
    #[inline(always)]
    pub fn busstate(&self) -> BUSSTATE_R {
        BUSSTATE_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - Bus Error"]
    #[inline(always)]
...
impl crate::attiny412pac::RegisterSpec for MSTATUS_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [mstatus::R](R) reader structure"]
impl crate::attiny412pac::Readable for MSTATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mstatus::W](W) writer structure"]
impl crate::attiny412pac::Writable for MSTATUS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MSTATUS to value 0"]
impl crate::attiny412pac::Resettable for MSTATUS_SPEC {
    #[inline(always)]
