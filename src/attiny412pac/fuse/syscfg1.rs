...
pub struct R(crate::attiny412pac::R<SYSCFG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<SYSCFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<SYSCFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<SYSCFG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYSCFG1` writer"]
pub struct W(crate::attiny412pac::W<SYSCFG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<SYSCFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<SYSCFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<SYSCFG1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Startup Time\n\nValue on reset: 0"]
...
pub type SUT_R = crate::attiny412pac::FieldReader<u8, SUT_A>;
impl SUT_R {
...
pub type SUT_W<'a, const O: u8> = crate::attiny412pac::FieldWriterSafe<'a, u8, SYSCFG1_SPEC, u8, SUT_A, 3, O>;
...
impl crate::attiny412pac::RegisterSpec for SYSCFG1_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [syscfg1::R](R) reader structure"]
impl crate::attiny412pac::Readable for SYSCFG1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [syscfg1::W](W) writer structure"]
impl crate::attiny412pac::Writable for SYSCFG1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SYSCFG1 to value 0"]
impl crate::attiny412pac::Resettable for SYSCFG1_SPEC {
    #[inline(always)]
