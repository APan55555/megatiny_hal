...
pub struct R(crate::attiny412pac::R<OSCCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<OSCCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<OSCCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<OSCCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OSCCFG` writer"]
pub struct W(crate::attiny412pac::W<OSCCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<OSCCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<OSCCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<OSCCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FREQSEL_R = crate::attiny412pac::FieldReader<u8, FREQSEL_A>;
impl FREQSEL_R {
...
pub type FREQSEL_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, OSCCFG_SPEC, u8, FREQSEL_A, 2, O>;
...
pub type OSCLOCK_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `OSCLOCK` writer - Oscillator Lock"]
pub type OSCLOCK_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, OSCCFG_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - Frequency Select"]
    #[inline(always)]
    pub fn freqsel(&self) -> FREQSEL_R {
        FREQSEL_R::new((self.bits & 3) as u8)
    }
...
impl crate::attiny412pac::RegisterSpec for OSCCFG_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [osccfg::R](R) reader structure"]
impl crate::attiny412pac::Readable for OSCCFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [osccfg::W](W) writer structure"]
impl crate::attiny412pac::Writable for OSCCFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OSCCFG to value 0"]
impl crate::attiny412pac::Resettable for OSCCFG_SPEC {
    #[inline(always)]
