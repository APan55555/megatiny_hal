...
pub struct R(crate::attiny412pac::R<ASYNCUSER10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER10` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER10_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER10_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER10_A>;
impl ASYNCUSER10_R {
...
pub type ASYNCUSER10_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER10_SPEC, u8, ASYNCUSER10_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER10_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser10::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER10_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser10::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER10_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER10 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER10_SPEC {
    #[inline(always)]
