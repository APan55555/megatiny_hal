...
pub struct R(crate::attiny412pac::R<SYNCUSER0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<SYNCUSER0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<SYNCUSER0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<SYNCUSER0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYNCUSER0` writer"]
pub struct W(crate::attiny412pac::W<SYNCUSER0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<SYNCUSER0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<SYNCUSER0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<SYNCUSER0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNCUSER0_R = crate::attiny412pac::FieldReader<u8, SYNCUSER0_A>;
impl SYNCUSER0_R {
...
pub type SYNCUSER0_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, SYNCUSER0_SPEC, u8, SYNCUSER0_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for SYNCUSER0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [syncuser0::R](R) reader structure"]
impl crate::attiny412pac::Readable for SYNCUSER0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [syncuser0::W](W) writer structure"]
impl crate::attiny412pac::Writable for SYNCUSER0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SYNCUSER0 to value 0"]
impl crate::attiny412pac::Resettable for SYNCUSER0_SPEC {
    #[inline(always)]
