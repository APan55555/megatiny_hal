...
pub struct R(crate::attiny412pac::R<ASYNCUSER3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER3` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER3_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER3_A>;
impl ASYNCUSER3_R {
...
pub type ASYNCUSER3_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER3_SPEC, u8, ASYNCUSER3_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER3_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser3::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser3::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER3 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER3_SPEC {
    #[inline(always)]
