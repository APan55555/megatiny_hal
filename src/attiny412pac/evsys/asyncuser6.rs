...
pub struct R(crate::attiny412pac::R<ASYNCUSER6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER6` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER6_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER6_A>;
impl ASYNCUSER6_R {
...
pub type ASYNCUSER6_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER6_SPEC, u8, ASYNCUSER6_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER6_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser6::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser6::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER6 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER6_SPEC {
    #[inline(always)]
