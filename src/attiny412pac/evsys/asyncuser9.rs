...
pub struct R(crate::attiny412pac::R<ASYNCUSER9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER9` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER9_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER9_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER9_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER9_A>;
impl ASYNCUSER9_R {
...
pub type ASYNCUSER9_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER9_SPEC, u8, ASYNCUSER9_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER9_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser9::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser9::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER9_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER9 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER9_SPEC {
    #[inline(always)]
