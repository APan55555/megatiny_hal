...
pub struct R(crate::attiny412pac::R<ASYNCUSER4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER4` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER4_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER4_A>;
impl ASYNCUSER4_R {
...
pub type ASYNCUSER4_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER4_SPEC, u8, ASYNCUSER4_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER4_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser4::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser4::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER4 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER4_SPEC {
    #[inline(always)]
