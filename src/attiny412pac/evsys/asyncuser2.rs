...
pub struct R(crate::attiny412pac::R<ASYNCUSER2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER2` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER2_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER2_A>;
impl ASYNCUSER2_R {
...
pub type ASYNCUSER2_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER2_SPEC, u8, ASYNCUSER2_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER2_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser2::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser2::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER2 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER2_SPEC {
    #[inline(always)]
