...
pub struct R(crate::attiny412pac::R<ASYNCUSER0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<ASYNCUSER0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<ASYNCUSER0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<ASYNCUSER0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER0` writer"]
pub struct W(crate::attiny412pac::W<ASYNCUSER0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<ASYNCUSER0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<ASYNCUSER0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<ASYNCUSER0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ASYNCUSER0_R = crate::attiny412pac::FieldReader<u8, ASYNCUSER0_A>;
impl ASYNCUSER0_R {
...
pub type ASYNCUSER0_W<'a, const O: u8> =
    crate::attiny412pac::FieldWriter<'a, u8, ASYNCUSER0_SPEC, u8, ASYNCUSER0_A, 8, O>;
...
impl crate::attiny412pac::RegisterSpec for ASYNCUSER0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [asyncuser0::R](R) reader structure"]
impl crate::attiny412pac::Readable for ASYNCUSER0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [asyncuser0::W](W) writer structure"]
impl crate::attiny412pac::Writable for ASYNCUSER0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASYNCUSER0 to value 0"]
impl crate::attiny412pac::Resettable for ASYNCUSER0_SPEC {
    #[inline(always)]
