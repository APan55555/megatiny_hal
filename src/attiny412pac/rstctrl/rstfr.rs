...
pub struct R(crate::attiny412pac::R<RSTFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::attiny412pac::R<RSTFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::attiny412pac::R<RSTFR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::attiny412pac::R<RSTFR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RSTFR` writer"]
pub struct W(crate::attiny412pac::W<RSTFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::attiny412pac::W<RSTFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::attiny412pac::W<RSTFR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::attiny412pac::W<RSTFR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PORF` reader - Power on Reset flag"]
pub type PORF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `PORF` writer - Power on Reset flag"]
pub type PORF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
#[doc = "Field `BORF` reader - Brown out detector Reset flag"]
pub type BORF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `BORF` writer - Brown out detector Reset flag"]
pub type BORF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
#[doc = "Field `EXTRF` reader - External Reset flag"]
pub type EXTRF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `EXTRF` writer - External Reset flag"]
pub type EXTRF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
#[doc = "Field `WDRF` reader - Watch dog Reset flag"]
pub type WDRF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `WDRF` writer - Watch dog Reset flag"]
pub type WDRF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
#[doc = "Field `SWRF` reader - Software Reset flag"]
pub type SWRF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `SWRF` writer - Software Reset flag"]
pub type SWRF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
#[doc = "Field `UPDIRF` reader - UPDI Reset flag"]
pub type UPDIRF_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `UPDIRF` writer - UPDI Reset flag"]
pub type UPDIRF_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, RSTFR_SPEC, bool, O>;
impl R {
...
impl crate::attiny412pac::RegisterSpec for RSTFR_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [rstfr::R](R) reader structure"]
impl crate::attiny412pac::Readable for RSTFR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rstfr::W](W) writer structure"]
impl crate::attiny412pac::Writable for RSTFR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RSTFR to value 0"]
impl crate::attiny412pac::Resettable for RSTFR_SPEC {
    #[inline(always)]
