...
pub type EVOUT0_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `EVOUT0` writer - Event Output 0"]
pub type EVOUT0_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
#[doc = "Field `EVOUT1` reader - Event Output 1"]
pub type EVOUT1_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `EVOUT1` writer - Event Output 1"]
pub type EVOUT1_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
#[doc = "Field `EVOUT2` reader - Event Output 2"]
pub type EVOUT2_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `EVOUT2` writer - Event Output 2"]
pub type EVOUT2_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
...
pub type LUT0_R = crate::attiny412pac::BitReader<LUT0_A>;
impl LUT0_R {
...
pub type LUT0_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, LUT0_A, O>;
...
pub type LUT1_R = crate::attiny412pac::BitReader<LUT1_A>;
impl LUT1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type LUT1_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, LUT1_A, O>;
