...
pub type RS485_R = crate::attiny412pac::FieldReader<u8, RS485_A>;
impl RS485_R {
...
pub type RS485_W<'a, const O: u8> = crate::attiny412pac::FieldWriter<'a, u8, CTRLA_SPEC, u8, RS485_A, 2, O>;
...
pub type ABEIE_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `ABEIE` writer - Auto-baud Error Interrupt Enable"]
pub type ABEIE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
#[doc = "Field `LBME` reader - Loop-back Mode Enable"]
pub type LBME_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `LBME` writer - Loop-back Mode Enable"]
pub type LBME_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
#[doc = "Field `RXSIE` reader - Receiver Start Frame Interrupt Enable"]
pub type RXSIE_R = crate::attiny412pac::BitReader<bool>;
#[doc = "Field `RXSIE` writer - Receiver Start Frame Interrupt Enable"]
pub type RXSIE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
...
pub type DREIE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
...
pub type TXCIE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
...
pub type RXCIE_W<'a, const O: u8> = crate::attiny412pac::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - RS485 Mode internal transmitter"]
    #[inline(always)]
    pub fn rs485(&self) -> RS485_R {
        RS485_R::new((self.bits & 3) as u8)
    }
