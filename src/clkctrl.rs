...
pub struct RegisterBlock {
    ...
    pub mclkctrla: crate::Reg<mclkctrla::MCLKCTRLA_SPEC>,
    #[doc = "0x01 - MCLK Control B"]
    pub mclkctrlb: crate::Reg<mclkctrlb::MCLKCTRLB_SPEC>,
    #[doc = "0x02 - MCLK Lock"]
    pub mclklock: crate::Reg<mclklock::MCLKLOCK_SPEC>,
    #[doc = "0x03 - MCLK Status"]
    pub mclkstatus: crate::Reg<mclkstatus::MCLKSTATUS_SPEC>,
    _reserved4: [u8; 0x0c],
    #[doc = "0x10 - OSC20M Control A"]
    pub osc20mctrla: crate::Reg<osc20mctrla::OSC20MCTRLA_SPEC>,
    #[doc = "0x11 - OSC20M Calibration A"]
    pub osc20mcaliba: crate::Reg<osc20mcaliba::OSC20MCALIBA_SPEC>,
    #[doc = "0x12 - OSC20M Calibration B"]
    pub osc20mcalibb: crate::Reg<osc20mcalibb::OSC20MCALIBB_SPEC>,
    _reserved7: [u8; 0x05],
    #[doc = "0x18 - OSC32K Control A"]
    pub osc32kctrla: crate::Reg<osc32kctrla::OSC32KCTRLA_SPEC>,
}
